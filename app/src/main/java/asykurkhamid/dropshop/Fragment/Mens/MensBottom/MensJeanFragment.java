 ...
 */
public class MensJeanFragment extends Fragment {

    private DatabaseReference reference;
    private DatabaseReference mDatabase;
    private RecyclerView rvJeans;
    private View view;
    private String path1 = "Pria";
    private String path2 = "Bawahan Pria";
    private String path3 = "Celana Jeans Pria";

    public MensJeanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_mens_jean, container, false);
        rvJeans = view.findViewById(R.id.rvMensJeans);
        return view;
    }
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    int column = 2;
                    rvJeans.setLayoutManager(new GridLayoutManager(getContext(),column));
                    CatalogAdapter adapter = new CatalogAdapter(getContext(),jaket);
                    rvJeans.setHasFixedSize(true);
                    rvJeans.setAdapter(adapter);
                }
            }
