 ...
 */
public class MensKemejaFragment extends Fragment {

    private DatabaseReference reference;
    private DatabaseReference mDatabase;
    private RecyclerView rvKemeja;
    private View view;
    private String path1 = "Pria";
    private String path2 = "Atasan Pria";
    private String path3 = "Kemeja Pria";
    public MensKemejaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mens_kemeja, container, false);
        rvKemeja = view.findViewById(R.id.rvMensKemeja);
        return view;
    }
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    int column = 2;
                    rvKemeja.setLayoutManager(new GridLayoutManager(getContext(),column));
                    CatalogAdapter adapter = new CatalogAdapter(getContext(),jaket);
                    rvKemeja.setHasFixedSize(true);
                    rvKemeja.setAdapter(adapter);
                }
            }
