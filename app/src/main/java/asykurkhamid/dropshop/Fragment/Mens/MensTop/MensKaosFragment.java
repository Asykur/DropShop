 ...
 */
public class MensKaosFragment extends Fragment {

    private DatabaseReference reference;
    private DatabaseReference mDatabase;
    private RecyclerView rvKaos;
    private View view;
    private String path1 = "Pria";
    private String path2 = "Atasan Pria";
    private String path3 = "Kaos Pria";

    public MensKaosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mens_kaos, container, false);
        rvKaos = view.findViewById(R.id.rvMensKaos);
        return view;
    }
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    int column = 2;
                    rvKaos.setLayoutManager(new GridLayoutManager(getContext(),column));
                    CatalogAdapter adapter = new CatalogAdapter(getContext(),jaket);
                    rvKaos.setHasFixedSize(true);
                    rvKaos.setAdapter(adapter);
                }
            }
