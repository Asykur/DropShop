 ...
 */
public class MensShortsPantsFragment extends Fragment {
    private DatabaseReference reference;
    private DatabaseReference mDatabase;
    private RecyclerView rvShortPants;
    private View view;
    private String path1 = "Pria";
    private String path2 = "Bawahan Pria";
    private String path3 = "Celana Pendek Pria";

    public MensShortsPantsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_mens_shorts_pants, container, false);
        rvShortPants = view.findViewById(R.id.rvMensShortPants);
        return view;
    }
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    int column = 2;
                    rvShortPants.setLayoutManager(new GridLayoutManager(getContext(),column));
                    CatalogAdapter adapter = new CatalogAdapter(getContext(),jaket);
                    rvShortPants.setHasFixedSize(true);
                    rvShortPants.setAdapter(adapter);
                }
            }
