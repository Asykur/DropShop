 ...
 */
public class MensFormalPantsFragment extends Fragment {
    private DatabaseReference reference;
    private DatabaseReference mDatabase;
    private RecyclerView rvFormalPants;
    private View view;
    private String path1 = "Pria";
    private String path2 = "Bawahan Pria";
    private String path3 = "Celana Formal Pria";

    public MensFormalPantsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_mens_formal_pants, container, false);
        rvFormalPants = view.findViewById(R.id.rvMensFormalPants);
        return view;
    }
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    int column = 2;
                    rvFormalPants.setLayoutManager(new GridLayoutManager(getContext(),column));
                    CatalogAdapter adapter = new CatalogAdapter(getContext(),jaket);
                    rvFormalPants.setHasFixedSize(true);
                    rvFormalPants.setAdapter(adapter);
                }
            }
